...
namespace KevinDockx.API.Controllers
{
    ...
    public class CoursesController : ControllerBase
    {
        ...
        public ActionResult<CourseDto> GetCourseForAuthor(Guid authorId, Guid courseId)
        {
            ...
            var courseForAuthoreFromRepo = _courseLibraryRepository.GetCourse(authorId, courseId);
            if (courseForAuthoreFromRepo == null)
            {
                return NotFound();
            }

            return Ok(_mapper.Map<CourseDto>(courseForAuthoreFromRepo));
        }
