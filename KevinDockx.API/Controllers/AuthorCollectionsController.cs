...
namespace KevinDockx.API.Controllers
{
    ...
    public class AuthorCollectionsController : ControllerBase
    {
            ...
            IEnumerable<AuthorForCreationDto> authorCollection)
        {
            ...
            var idsAsStirng = string.Join(",", authorCollectionToReturn.Select(dto => dto.Id));

            return CreatedAtRoute("GetAuthorCollection", new {ids = idsAsStirng}, authorCollectionToReturn);
        }
    }
}